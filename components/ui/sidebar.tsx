...
function SidebarProvider({
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      // Toggle with [ key (only if not typing in an input/textarea)
      if (
        event.key === "[" &&
        !event.metaKey &&
        !event.ctrlKey &&
...
const sidebarMenuButtonVariants = cva(
  "ring-sidebar-ring text-muted-foreground [&_svg]:text-muted-foreground hover:bg-card hover:text-card-foreground hover:[&_svg]:text-card-foreground active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.4)] active:text-card-foreground active:[&_svg]:text-card-foreground dark:active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark:active:text-card-foreground dark:active:[&_svg]:text-card-foreground dark-cursor:active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark-cursor:active:text-card-foreground dark-cursor:active:[&_svg]:text-card-foreground dark-graphite:active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark-graphite:active:text-card-foreground dark-graphite:active:[&_svg]:text-card-foreground data-active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.4)] data-active:text-card-foreground data-active:[&_svg]:text-card-foreground dark:data-active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark:data-active:text-card-foreground dark:data-active:[&_svg]:text-card-foreground dark-cursor:data-active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark-cursor:data-active:text-card-foreground dark-cursor:data-active:[&_svg]:text-card-foreground dark-graphite:data-active:bg-[oklab(0.943853_0.00107113_0.000336707_/_0.06)] dark-graphite:data-active:text-card-foreground dark-graphite:data-active:[&_svg]:text-card-foreground data-open:hover:bg-card data-open:hover:text-card-foreground data-open:hover:[&_svg]:text-card-foreground gap-2 rounded-[6px] text-left text-[13px] transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 data-active:font-medium peer/menu-button flex w-full items-center overflow-hidden outline-hidden group/menu-button disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0 [&:not([data-collapsible=icon])]:px-[8px] [&:not([data-collapsible=icon])]:py-[8px]",
  {
    variants: {
      variant: {
